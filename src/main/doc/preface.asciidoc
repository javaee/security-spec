...
We would also like to thank Alex Kosowski, for his work putting together the JSR-375 proposal, submitting it to the JCP, recruiting a diverse and highly-qualified expert group, and leading the expert group through the initial stages of its work. Without Alex, there would be no JSR-375.
